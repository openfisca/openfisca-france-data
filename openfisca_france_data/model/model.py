...
prestation_by_name = collections.OrderedDict((
    ...
    build_simple_formula_couple('taux_accident_travail', FloatCol(function = cs_travail._taux_accident_travail,
    ...
    build_simple_formula_couple('cotpat_accident', FloatCol(function = cs_travail._cotpat_accident,
        label = u"Cotisations sociales patronales : accident du travail et maladies professionnelles",
        url = u"http://www.lesclesdelabanque.com/Web/Cdb/Entrepreneurs/Content.nsf/DocumentsByIDWeb/7APJB8?OpenDocument",
        )),
    build_simple_formula_couple('cotpat_noncontrib', FloatCol(function = cs_travail._cotpat_noncontrib,
        label = u"Cotisations sociales patronales non contributives",
        url = u"http://www.lesclesdelabanque.com/Web/Cdb/Entrepreneurs/Content.nsf/DocumentsByIDWeb/7APJB8?OpenDocument",
        )),
    build_simple_formula_couple('cotpat_main_d_oeuvre', FloatCol(function = cs_travail._cotpat_main_d_oeuvre,
        label = u"Cotisations sociales patronales main d'oeuvre",
        url = u"http://www.lesclesdelabanque.com/Web/Cdb/Entrepreneurs/Content.nsf/DocumentsByIDWeb/7APJB8?OpenDocument",
        )),
    build_simple_formula_couple('cotpat_transport', FloatCol(function = cs_travail._cotpat_transport,
        label = u"Cotisations sociales patronales: versement transport",
        url = u"http://www.lesclesdelabanque.com/Web/Cdb/Entrepreneurs/Content.nsf/DocumentsByIDWeb/7APJB8?OpenDocument",
        )),
    build_simple_formula_couple('cotpat', FloatCol(function = cs_travail._cotpat,
    ...
    build_simple_formula_couple('alleg_fillon', FloatCol(function = cs_travail._alleg_fillon,
    ...
    build_simple_formula_couple('alleg_cice', FloatCol(function = cs_travail._alleg_cice,
    ...
    build_simple_formula_couple('taxes_sal', FloatCol(function = cs_travail._taxes_sal,
    ...
    build_simple_formula_couple('tehr', FloatCol(function = cs_travail._tehr,
    ...
    build_simple_formula_couple('salsuperbrut', FloatCol(function = cs_travail._salsuperbrut,
        label = u"Salaires super bruts",
        url = u"http://www.insee.fr/fr/methodes/default.asp?page=definitions/cout-salarial.htm"
        )),

    build_simple_formula_couple('cotsal_contrib', FloatCol(function = cs_travail._cotsal_contrib,
    ...
    build_simple_formula_couple('cotsal_noncontrib', FloatCol(function = cs_travail._cotsal_noncontrib,
        label = u"Cotisations sociales non salariales non-contributives",
        )),
    build_simple_formula_couple('cotsal', FloatCol(function = cs_travail._cotsal,
        label = u"Cotisations sociales salariales",
        url = u"http://vosdroits.service-public.fr/particuliers/F2302.xhtml#N100F8",
        )),

    build_simple_formula_couple('csgsald', FloatCol(function = cs_travail._csgsald,
        label = u"CSG déductible sur les salaires",
        url = u"http://vosdroits.service-public.fr/particuliers/F2329.xhtml",
        )),
    build_simple_formula_couple('csgsali', FloatCol(function = cs_travail._csgsali,
        label = u"CSG imposables sur les salaires",
        url = u"http://vosdroits.service-public.fr/particuliers/F2329.xhtml",
        )),
    build_simple_formula_couple('crdssal', FloatCol(function = cs_travail._crdssal,
        label = u"CRDS sur les salaires",
        url = u"http://vosdroits.service-public.fr/particuliers/N17580.xhtml",
        )),
    build_simple_formula_couple('sal', FloatCol(function = cs_travail._sal,
        label = u"Salaires imposables",
        url = u"http://www.jureka.fr/dico-francais-droit/lettre-s/definition-salaire-imposable",
        )),
    build_simple_formula_couple('salnet', FloatCol(function = cs_travail._salnet,
    ...
    # Fonctionnaires
    build_simple_formula_couple('indemnite_residence', FloatCol(function = cs_travail._indemnite_residence,
    ...
    build_simple_formula_couple('cot_pat_pension_civile', FloatCol(function = cs_travail._cot_pat_pension_civile,
        label = u"Cotisation patronale pension civile",
        url = u"http://www.ac-besancon.fr/spip.php?article2662",
        )),
    build_simple_formula_couple('cot_sal_pension_civile', FloatCol(function = cs_travail._cot_sal_pension_civile,
        label = u"Cotisation salariale pension civile",
        url = u"http://www.ac-besancon.fr/spip.php?article2662",
        )),
    build_simple_formula_couple('cot_pat_rafp', FloatCol(function = cs_travail._cot_pat_rafp,
    ...
    build_simple_formula_couple('cot_sal_rafp', FloatCol(function = cs_travail._cot_sal_rafp,
    ...
    build_simple_formula_couple('csgchod', FloatCol(function = cs_remplac._csgchod,
        label = u"CSG déductible sur les allocations chômage",
        url = u"http://vosdroits.service-public.fr/particuliers/F2329.xhtml",
        )),
    build_simple_formula_couple('csgchoi', FloatCol(function = cs_remplac._csgchoi,
        label = u"CSG imposable sur les allocations chômage",
        url = u"http://vosdroits.service-public.fr/particuliers/F2329.xhtml",
        )),
    build_simple_formula_couple('crdscho', FloatCol(function = cs_remplac._crdscho,
    ...
    build_simple_formula_couple('cho', FloatCol(function = cs_remplac._cho,
        label = u"Allocations chômage imposables",
        url = u"http://www.insee.fr/fr/methodes/default.asp?page=definitions/chomage.htm",
        )),
    build_simple_formula_couple('chonet', FloatCol(function = cs_remplac._chonet,
    ...
    build_simple_formula_couple('csgrstd', FloatCol(function = cs_remplac._csgrstd,
    ...
    build_simple_formula_couple('csgrsti', FloatCol(function = cs_remplac._csgrsti,
        label = u"CSG imposable sur les pensions de retraite",
        url = u"https://www.lassuranceretraite.fr/cs/Satellite/PUBPrincipale/Retraites/Paiement-Votre-Retraite/Prelevements-Sociaux?packedargs=null",
        )),
    build_simple_formula_couple('crdsrst', FloatCol(function = cs_remplac._crdsrst,
    ...
    build_simple_formula_couple('rst', FloatCol(function = cs_remplac._rst,
        label = u"Pensions de retraite imposables",
        url = u"http://vosdroits.service-public.fr/particuliers/F415.xhtml",
        )),
    build_simple_formula_couple('rstnet', FloatCol(function = cs_remplac._rstnet,
        label = u"Pensions de retraite nettes",
        url = u"http://vosdroits.service-public.fr/particuliers/N20166.xhtml",
        )),
    build_simple_formula_couple('casa', FloatCol(function = cs_remplac._casa,
    ...
    build_simple_formula_couple('csg_cap_lib', FloatCol(function = cs_capital._csg_cap_lib,
    ...
    build_simple_formula_couple('crds_cap_lib', FloatCol(function = cs_capital._crds_cap_lib,
    ...
    build_simple_formula_couple('prelsoc_cap_lib', FloatCol(function = cs_capital._prelsoc_cap_lib,
    ...
    build_simple_formula_couple('csg_cap_bar', FloatCol(function = cs_capital._csg_cap_bar,
        label = u"CSG sur les revenus du capital soumis au barème",
        url = u"http://fr.wikipedia.org/wiki/Contribution_sociale_g%C3%A9n%C3%A9ralis%C3%A9e",
        )),
    build_simple_formula_couple('crds_cap_bar', FloatCol(function = cs_capital._crds_cap_bar,
        label = u"CRDS sur les revenus du capital soumis au barème",
        url = u"http://fr.wikipedia.org/wiki/Contribution_pour_le_remboursement_de_la_dette_sociale",
        )),
    build_dated_formula_couple('prelsoc_cap_bar',
        [
    ...
    build_simple_formula_couple('csg_fon', FloatCol(function = cs_capital._csg_fon,
        entity = "foy",
        label = u"CSG sur les revenus fonciers",
        url = u"http://fr.wikipedia.org/wiki/Contribution_sociale_g%C3%A9n%C3%A9ralis%C3%A9e",
        )),
    build_simple_formula_couple('crds_fon', FloatCol(function = cs_capital._crds_fon,
        entity = "foy",
        label = u"CRDS sur les revenus fonciers",
        url = u"http://vosdroits.service-public.fr/particuliers/F2329.xhtml",
        )),
    build_dated_formula_couple('prelsoc_fon',
        [
            dict(start = date(2002, 1, 1),
              end = date(2005, 12, 31),
    ...
    build_simple_formula_couple('csg_pv_mo', FloatCol(function = cs_capital._csg_pv_mo,
        entity = "foy",
    ...
    build_simple_formula_couple('crds_pv_mo', FloatCol(function = cs_capital._crds_pv_mo,
        entity = "foy",
        label = u"CRDS sur les plus-values de cession de valeurs mobilières",
        url = u"http://fr.wikipedia.org/wiki/Contribution_pour_le_remboursement_de_la_dette_sociale",
        )),
    build_dated_formula_couple('prelsoc_pv_mo',
        [
            dict(start = date(2002, 1, 1),
              end = date(2005, 12, 31),
    ...
    build_simple_formula_couple('csg_pv_immo', FloatCol(function = cs_capital._csg_pv_immo,
        entity = "foy",
        label = u"CSG sur les plus-values immobilières",
        url = u"http://fr.wikipedia.org/wiki/Contribution_sociale_g%C3%A9n%C3%A9ralis%C3%A9e",
        )),
    build_simple_formula_couple('crds_pv_immo', FloatCol(function = cs_capital._crds_pv_immo,
        entity = "foy",
        label = u"CRDS sur les plus-values immobilières",
        url = u"http://fr.wikipedia.org/wiki/Contribution_pour_le_remboursement_de_la_dette_sociale",
        )),
    build_dated_formula_couple('prelsoc_pv_immo',
        [
            dict(start = date(2002, 1, 1),
              end = date(2005, 12, 31),
    ...
    build_simple_formula_couple('ir_lps', FloatCol(function = cs_lps._ir_lps,
        start = date(2010, 1, 1),
...
#        )),
    ...
    build_simple_formula_couple('marpac', BoolCol(function = ir._marpac,
        entity = 'foy')),
    build_simple_formula_couple('celdiv', BoolCol(function = ir._celdiv,
        entity = 'foy')),
    build_simple_formula_couple('veuf', BoolCol(function = ir._veuf,
        entity = 'foy')),
    build_simple_formula_couple('jveuf', BoolCol(function = ir._jveuf,
        entity = 'foy')),
    build_simple_formula_couple('nbptr', FloatCol(function = ir._nbptr,
        entity = 'foy',
        label = u"Nombre de parts",
        url = u"http://vosdroits.service-public.fr/particuliers/F2705.xhtml",
        )),
    build_simple_formula_couple('rbg', FloatCol(function = ir._rbg,
        entity = 'foy',
    ...
    # charges déductibles
    build_simple_formula_couple('cd_penali', FloatCol(function = cd._cd_penali,
        entity = 'foy',
        url = u"http://frederic.anne.free.fr/Cours/ITV.htm",
        )),
    build_simple_formula_couple('cd_acc75a', FloatCol(function = cd._cd_acc75a,
        entity = 'foy')),
    build_dated_formula_couple('cd_percap',
        [
            dict(start = date(2002, 1, 1),
              end = date(2002, 12, 31),
        ...
        FloatCol(entity='foy')),
    build_simple_formula_couple('cd_deddiv', FloatCol(function = cd._cd_deddiv,
        entity = 'foy')),
    build_simple_formula_couple('cd_doment', FloatCol(function = cd._cd_doment,
        entity = 'foy',
        start = date(2002, 1, 1),
        end = date(2005, 12, 31))),
    build_simple_formula_couple('cd_eparet', FloatCol(function = cd._cd_eparet,
        entity = 'foy',
        start = date(2004, 1, 1))),
    build_simple_formula_couple('cd_sofipe', FloatCol(function = cd._cd_sofipe,
        entity = 'foy',
        start = date(2002, 1, 1),
        end = date(2006, 12, 31))),
    build_simple_formula_couple('cd_cinema', FloatCol(function = cd._cd_cinema,
        entity = 'foy',
        start = date(2002, 1, 1),
        end = date(2005, 12, 31))),
    build_simple_formula_couple('cd_ecodev', FloatCol(function = cd._cd_ecodev,
        entity = 'foy',
        start = date(2007, 1, 1),
        end = date(2008, 12, 31))),
    build_simple_formula_couple('cd_grorep', FloatCol(function = cd._cd_grorep,
        entity = 'foy',
        start = date(2009, 1, 1))),

    build_simple_formula_couple('charges_deduc_reforme', FloatCol(function = cd._charges_deduc_reforme,
        entity = 'foy',
        url = u"http://www.bfmtv.com/economie/reforme-fiscale-csg-bientot-plus-deductible-l-impot-revenu-700700.html",
        )),
    build_simple_formula_couple('charge_loyer', FloatCol(function = cd._charge_loyer,
        entity = 'foy',
        url = u"http://vosdroits.service-public.fr/particuliers/F1991.xhtml",
        )),

    build_simple_formula_couple('rbg_int', FloatCol(function = cd._rbg_int,
        entity = 'foy',
    ...
    build_simple_formula_couple('charges_deduc', FloatCol(function = cd._charges_deduc,
        entity = 'foy',
    ...
    build_simple_formula_couple('indu_plaf_abat_pen', FloatCol(function = ir._indu_plaf_abat_pen,
        entity = 'foy')),
    build_simple_formula_couple('abat_sal_pen', FloatCol(function = ir._abat_sal_pen,
        start = date(2002, 1, 1),
        end = date(2005, 12, 31))),
    build_simple_formula_couple('sal_pen_net', FloatCol(function = ir._sal_pen_net)),
    build_simple_formula_couple('rto', FloatCol(function = ir._rto,
        label = u'Rentes viagères (rentes à titre onéreux)',
        url = u"http://fr.wikipedia.org/wiki/Rente_viag%C3%A8re",
        )),
    build_simple_formula_couple('rto_net', FloatCol(function = ir._rto_net,
    ...
    build_simple_formula_couple('rev_cat_tspr', FloatCol(function = ir._rev_cat_tspr,
        entity = 'foy',
    ...
    build_dated_formula_couple('rev_cat_rvcm',
        [
            dict(start = date(2002, 1, 1),
              end = date(2004, 12, 31),
        ...
        url = u"http://www.insee.fr/fr/methodes/default.asp?page=definitions/revenus-categoriesl.htm")),
    build_simple_formula_couple('rev_cat_rpns', FloatCol(function = ir._rev_cat_rpns,
        entity = 'foy',
        label = u'Revenu catégoriel - Rpns',
        url = u"http://www.insee.fr/fr/methodes/default.asp?page=definitions/revenus-categoriesl.htm",
        )),
    build_simple_formula_couple('rev_cat_rfon', FloatCol(function = ir._rev_cat_rfon,
        entity = 'foy',
        label = u'Revenu catégoriel - Foncier',
        url = u"http://www.insee.fr/fr/methodes/default.asp?page=definitions/revenus-categoriesl.htm",
        )),
    build_simple_formula_couple('rev_cat_pv', FloatCol(function = ir._rev_cat_pv,
        entity = 'foy',
        label = u'Revenu catégoriel - Plus-values',
        url = u"http://www.insee.fr/fr/methodes/default.asp?page=definitions/revenus-categoriesl.htm",
        start = date(2013, 1, 1))),
    build_simple_formula_couple('rev_cat', FloatCol(function = ir._rev_cat,
        entity = 'foy',
        label = u"Revenus catégoriels",
        url = u"http://www.insee.fr/fr/methodes/default.asp?page=definitions/revenus-categoriesl.htm",
        )),
    build_simple_formula_couple('deficit_rcm', FloatCol(function = ir._deficit_rcm,
        entity = 'foy',
        ...
        start = date(2009,1,1))),
    build_simple_formula_couple('csg_deduc_patrimoine_simulated', FloatCol(function = ir._csg_deduc_patrimoine_simulated,
        entity = 'foy',
    ...
    build_simple_formula_couple('csg_deduc_patrimoine', FloatCol(function = ir._csg_deduc_patrimoine,
        entity = 'foy',
        label = u'Csg déductible sur le patrimoine',
        url = u"http://www.impots.gouv.fr/portal/dgi/public/particuliers.impot?pageId=part_ctrb_soc&typePage=cpr02&sfid=503&espId=1&communaute=1&impot=CS",
        )),
    build_simple_formula_couple('csg_deduc', FloatCol(function = ir._csg_deduc,
        entity = 'foy',
        label = u'Csg déductible sur le patrimoine',
        url = u"http://www.impots.gouv.fr/portal/dgi/public/particuliers.impot?pageId=part_ctrb_soc&typePage=cpr02&sfid=503&espId=1&communaute=1&impot=CS",
        )),

    build_dated_formula_couple('plus_values',
        [
            dict(start = date(2007, 1, 1),
              end = date(2007, 12, 31),
        ...
        FloatCol(entity='foy')),
    build_simple_formula_couple('ir_brut', FloatCol(function = ir._ir_brut,
        entity = 'foy')),
    build_simple_formula_couple('nb_pac', FloatCol(function = ir._nb_pac,
        entity = 'foy')),
    build_simple_formula_couple('nb_adult', FloatCol(function = ir._nb_adult,
        entity = 'foy')),
    build_simple_formula_couple('ir_ss_qf', FloatCol(function = ir._ir_ss_qf,
        entity = 'foy')),
    build_simple_formula_couple('ir_plaf_qf', FloatCol(function = ir._ir_plaf_qf,
        entity = 'foy')),
    build_simple_formula_couple('avantage_qf', FloatCol(function = ir._avantage_qf,
        entity = 'foy')),
    build_simple_formula_couple('nat_imp', FloatCol(function = ir._nat_imp,
        entity = 'foy')),
    build_simple_formula_couple('decote', FloatCol(function = ir._decote,
        entity = 'foy')),

    # réductions d'impots
#    build_simple_formula_couple('donapd', FloatCol(function = ri._donapd,
#        entity = 'foy')),
    build_dated_formula_couple(
        'donapd',
        [dict(start = date(2002, 1, 1),
        ...
        FloatCol(entity = 'foy')),
#    build_simple_formula_couple('dfppce', FloatCol(function = ri._dfppce,
#        entity = 'foy')),
    build_dated_formula_couple(
        'dfppce',
        [dict(start = date(2002, 1, 1),
         ...
         dict(start = date(2012, 1, 1),
             ...
             function = ri._dfppce_2012_2013,
             ),
        ],
        FloatCol(entity = 'foy')),

    build_simple_formula_couple('cotsyn', FloatCol(function = ri._cotsyn,
        entity = 'foy')),
    build_dated_formula_couple('resimm', [
         dict(start = date(2009, 1, 1),
             end = date(2010, 12, 31),
    ...
    FloatCol(entity = 'foy')),
    build_dated_formula_couple('patnat', [
	...
	[
         dict(start = date(2009, 1, 1),
             ...
             function = ri._sofipe_2009_2010,
             ),
         dict(start = date(2011, 1, 1),
             end = date(2011, 12, 31),
             function = ri._sofipe_2011,
             ),
        ],
        FloatCol(entity= 'foy')),
    build_dated_formula_couple('saldom',
        [
         dict(start = date(2002, 1, 1),
             end = date(2004, 12, 31),
         ...
         dict(start = date(2014, 1, 1),
             ...
             function = ri._saldom_2014,
             ),
        ],
        FloatCol(entity= 'foy')),
    build_simple_formula_couple('intagr', FloatCol(function = ri._intagr,
        entity = 'foy',
        start = date(2005, 1, 1))),
    build_simple_formula_couple('prcomp', FloatCol(function = ri._prcomp,
        entity = 'foy')),
    build_dated_formula_couple('spfcpi',
        [
        ...
        FloatCol(entity= 'foy')),
    build_simple_formula_couple('mohist', FloatCol(function = ri._mohist,
        entity = 'foy',
        start = date(2008, 1, 1))),
    build_simple_formula_couple('sofica', FloatCol(function = ri._sofica,
        entity = 'foy',
        start = date(2006, 1, 1))),
    build_dated_formula_couple('cappme',
        [
         dict(start = date(2002, 1, 1), #quid d'avant 2002 ?
             end = date(2002, 12, 31),
        ...
        FloatCol(entity= 'foy')),
    build_simple_formula_couple('repsoc', FloatCol(function = ri._repsoc,
        entity = 'foy',
        start = date(2003, 1, 1))),
    build_dated_formula_couple('invfor',
	[
	 dict(start = date(2002, 1, 1),
	      end = date(2005, 12, 31),
	...
	FloatCol(entity = 'foy')),
    build_simple_formula_couple('deffor', FloatCol(function = ri._deffor,
        entity = 'foy',
        start = date(2006, 1, 1))),
    build_simple_formula_couple('daepad', FloatCol(function = ri._daepad,
        entity = 'foy')),
    build_simple_formula_couple('rsceha', FloatCol(function = ri._rsceha,
        entity = 'foy')),
    build_dated_formula_couple('invlst',
        [
         dict(start = date(2004, 1, 1),
              end = date(2004, 12, 31),
        ...
        FloatCol(entity = 'foy')),
    build_dated_formula_couple('domlog',
        [
         dict(start = date(2002, 1, 1),
              end = date(2002, 12, 31),
        ...
        FloatCol(entity = 'foy')),
    build_simple_formula_couple('adhcga', FloatCol(function = ri._adhcga,
        entity = 'foy')),
    build_dated_formula_couple('creaen',
        [
         dict(start = date(2006, 1, 1),
              end = date(2008, 12, 31),
        ...
        FloatCol(entity = 'foy')),
    build_simple_formula_couple('ecpess', FloatCol(function = ri._ecpess,
        entity = 'foy')),
    build_dated_formula_couple('scelli',
        [
         dict(start = date(2009, 1, 1),
              end = date(2009, 12, 31),
        ...
        FloatCol(entity = 'foy')),
    build_simple_formula_couple('locmeu', FloatCol(function = ri._locmeu,
        entity = 'foy',
        start = date(2009, 1, 1),
        end = date(2010, 12, 31))),
    build_simple_formula_couple('doment', FloatCol(function = ri._doment,
        entity = 'foy')),
    build_simple_formula_couple('domsoc', FloatCol(function = ri._domsoc,
        entity = 'foy')),
    build_simple_formula_couple('intemp', FloatCol(function = ri._intemp,
        entity = 'foy',
        start = date(2002, 1, 1),
        end = date(2003, 12, 31))),
    build_dated_formula_couple('garext',
        [
         dict(start = date(2002, 1, 1),
              end = date(2002, 12, 31),
        ...
        FloatCol(entity = 'foy')),
    build_simple_formula_couple('assvie', FloatCol(function = ri._assvie,
        entity = 'foy',
        start = date(2002, 1, 1),
        end = date(2004, 12, 31))),
    build_simple_formula_couple('invrev', FloatCol(function = ri._invrev,
        entity = 'foy',
        start = date(2002, 1, 1),
        end = date(2003, 12, 31))),
    build_simple_formula_couple('intcon', FloatCol(function = ri._intcon,
        entity = 'foy',
        start = date(2004, 1, 1),
        end = date(2005, 12, 31))),
    build_simple_formula_couple('ecodev', FloatCol(function = ri._ecodev,
        entity = 'foy',
        start = date(2009, 1, 1),
        end = date(2009, 12, 31))),

    build_simple_formula_couple('nb_pac2', FloatCol(function = ci._nb_pac2,
        entity = 'foy')),

    build_simple_formula_couple('creimp_exc_2008', FloatCol(function = ci._creimp_exc_2008,
        entity = 'foy')),

    build_simple_formula_couple('ip_net', FloatCol(function = ir._ip_net,
        entity = 'foy')),
#    build_simple_formula_couple('reductions', FloatCol(function = ri._reductions,
#        entity = 'foy')),
    build_dated_formula_couple(
        'reductions',
        [dict(start = date(2002, 1, 1),
    ...
    build_simple_formula_couple('iaidrdi', FloatCol(function = ir._iaidrdi,
        entity = 'foy')),
    build_simple_formula_couple('teicaa', FloatCol(function = ir._teicaa,
        entity = 'foy')),
    build_simple_formula_couple('cont_rev_loc', FloatCol(function = ir._cont_rev_loc,
        entity = 'foy',
        start = date(2001, 1, 1))),
    build_simple_formula_couple('iai', FloatCol(function = ir._iai,
        entity = 'foy',
    ...
    build_simple_formula_couple('cehr', FloatCol(function = ir._cehr,
        entity = 'foy',
...
#    build_simple_formula_couple('cesthra', FloatCol(function = ir._cesthra,
#        entity = 'foy',
#        start = date(2013, 1, 1),
#        )), # PLF 2013, amendement rejeté
    build_dated_formula_couple('imp_lib',# TODO: Check - de 2000euros
        [
            dict(start = date(2002, 1, 1),
              end = date(2007, 12, 31),
        ...
        FloatCol(entity='foy',
        url = u"http://www.impots.gouv.fr/portal/dgi/public/particuliers.impot?pageId=part_ctrb_soc&paf_dm=popup&paf_gm=content&typePage=cpr02&sfid=501&espId=1&impot=CS")),
    build_simple_formula_couple('assiette_vente', FloatCol(function = ir._micro_social_vente,
        entity = 'foy',
        start = date(2009, 1, 1))),
    build_simple_formula_couple('assiette_service', FloatCol(function = ir._micro_social_service,
        entity = 'foy',
        start = date(2009, 1, 1))),
    build_simple_formula_couple('assiette_proflib', FloatCol(function = ir._micro_social_proflib,
        entity = 'foy',
        start = date(2009, 1, 1))),
    build_simple_formula_couple('microsocial', FloatCol(function = ir._micro_social_2009_,
        entity = 'foy',
        start = date(2009, 1, 1),
    ...
    build_simple_formula_couple('rev_act_nonsal', FloatCol(function = ir._rev_act_nonsal,
        entity = 'ind')),
    build_simple_formula_couple('rev_act_sal', FloatCol(function = ir._rev_act_sal,
        entity = 'ind')),
    build_simple_formula_couple('rev_act', FloatCol(function = ir._rev_act,
        entity = 'ind')),
    build_simple_formula_couple('ppe_coef', FloatCol(function = ir._ppe_coef,
        entity = 'foy')),
    ...
    build_simple_formula_couple('ppe_elig', BoolCol(function = ir._ppe_elig,
        entity = 'foy')),
    ...
    build_simple_formula_couple('ppe_brute', FloatCol(function = ir._ppe_brute,
        entity = 'foy',
        label = u"Prime pour l'emploi brute",
        )),
    build_simple_formula_couple('ppe', FloatCol(function = ir._ppe,
        entity = 'foy',
...
#    build_simple_formula_couple('creimp', FloatCol(function = ci._creimp,
#        entity = 'foy')), #TODO : adrien transform as credit_impot
    ...
    build_simple_formula_couple('mecena', FloatCol(function = ci._mecena,
        entity = 'foy',
        start = date(2003, 1, 1))),
    build_simple_formula_couple('prlire', FloatCol(function = ci._prlire,
        entity = 'foy',
        label = u"Prélèvement libératoire à restituer (case 2DH)",
        end = date(2013, 12, 31))),
    build_dated_formula_couple('aidper',
	...
	FloatCol(entity='foy')),
    build_dated_formula_couple('quaenv',
	[
   	 dict(start = date(2005, 1, 1),
	      end = date(2005, 12, 31),
   	 ...
   	 dict(start = date(2012, 1, 1),
	      end = date(2013, 12, 31), #TODO: changer date
	      function = ci._quaenv_2012,
	     ),
	],
	FloatCol(entity='foy')),
    build_simple_formula_couple('drbail', FloatCol(function = ci._drbail,
        entity = 'foy')),
    build_simple_formula_couple('ci_garext', FloatCol(function = ci._ci_garext,
        entity = 'foy',
        start = date(2005, 1, 1))),
    build_dated_formula_couple('preetu',
        [
            dict(start = date(2005, 1, 1),
              end = date(2005, 12, 31),
        ...
        FloatCol(entity='foy')),
    build_dated_formula_couple('saldom2',
        [
            dict(start = date(2007, 1, 1),
              end = date(2008, 12, 31),
            ...
            dict(start = date(2009, 1, 1),
              ...
              function = ci._saldom2_2009_2010,
             ),
            dict(start = date(2011, 1, 1),
              end = date(2015, 12, 31),
              function = ci._saldom2_2011_,
             ),
        ],
        FloatCol(entity='foy')),
    build_dated_formula_couple('inthab',
	[
   	 dict(start = date(2008, 1, 1),
	      end = date(2008, 12, 31),
	...
	FloatCol(entity='foy')),
    build_simple_formula_couple('assloy', FloatCol(function = ci._assloy,
        entity = 'foy',
        start = date(2005, 1, 1))),
    build_simple_formula_couple('autent', FloatCol(function = ci._autent,
        entity = 'foy',
        start = date(2009, 1, 1))),
    build_simple_formula_couple('acqgpl', FloatCol(function = ci._acqgpl,
        entity = 'foy',
        start = date(2002, 1, 1),
        end = date(2007, 12, 31))),
    build_simple_formula_couple('divide', FloatCol(function = ci._divide,
        entity = 'foy',
        start = date(2005, 1, 1),
        end = date(2009, 12, 31))),
    build_simple_formula_couple('aidmob', FloatCol(function = ci._aidmob,
        entity = 'foy',
        start = date(2005, 1, 1),
        end = date(2008, 12, 31))),

    build_simple_formula_couple('jeunes', FloatCol(function = ci._jeunes_2005_2008,
        entity = 'foy',
        start = date(2005, 1, 1),
        end = date(2008, 12, 31))),
    build_simple_formula_couple('jeunes_ind', FloatCol(function = ci._jeunes_ind,
        entity = 'ind',
        start = date(2005, 1, 1),
        end = date(2008, 12, 31))),
    build_dated_formula_couple(
    ...
    build_simple_formula_couple('irpp', FloatCol(function = ir._irpp,
        entity = 'foy',
        label = u"Impôt sur le revenu des personnes physiques",
        url = u"http://www.impots.gouv.fr/portal/dgi/public/particuliers.impot?pageId=part_impot_revenu&espId=1&impot=IR&sfid=50",
        )),

    build_simple_formula_couple('rfr', FloatCol(function = ir._rfr,
        entity = 'foy',
        label = u"Revenu fiscal de référence",
        )),
    build_simple_formula_couple('rfr_rvcm', FloatCol(function = ir._rfr_rvcm,
        entity = 'foy')),

#    build_simple_formula_couple('alv', FloatCol(function = ir._alv)),
    build_simple_formula_couple('glo', FloatCol(function = ir._glo,
    ...
    build_simple_formula_couple('fon', FloatCol(function = ir._fon,
        entity = 'foy',
    ...
    build_simple_formula_couple('rev_cap_bar', FloatCol(function = ir._rev_cap_bar,
        entity = 'foy',
        url = u"http://fr.wikipedia.org/wiki/Revenu#Revenu_du_Capital",
        )),
    build_dated_formula_couple('rev_cap_lib',
        [
            dict(start = date(2002, 1, 1),
              end = date(2007, 12, 31),
        ...
        FloatCol(entity='foy',
        url = u"http://fr.wikipedia.org/wiki/Revenu#Revenu_du_Capital")),
    build_simple_formula_couple('avf', FloatCol(function = ir._avf,
        entity = 'foy')),
    ...
    ############################################################
    build_simple_formula_couple('isf_imm_bati', FloatCol(function = isf._isf_imm_bati,
        entity = 'foy')),
    build_simple_formula_couple('isf_imm_non_bati', FloatCol(function = isf._isf_imm_non_bati,
        entity = 'foy')),
    build_simple_formula_couple('isf_actions_sal', FloatCol(function = isf._isf_actions_sal,
        entity = 'foy',
        start = date(2006, 1, 1))),
    build_simple_formula_couple('isf_droits_sociaux', FloatCol(function = isf._isf_droits_sociaux,
        entity = 'foy')),
    build_simple_formula_couple('ass_isf', FloatCol(function = isf._ass_isf,
        entity = 'foy')),
    build_dated_formula_couple('isf_iai',
        [
            dict(start = date(2011, 1, 1),
              end = date(2015, 12, 31),
        ...
        FloatCol(entity='foy')),
    build_simple_formula_couple('tot_impot', FloatCol(function = isf._tot_impot,
        entity = 'foy')),
    build_simple_formula_couple('isf_avant_plaf', FloatCol(function = isf._isf_avant_plaf,
        entity = 'foy')),
    build_simple_formula_couple('isf_avant_reduction', FloatCol(function = isf._isf_avant_reduction,
        entity = 'foy')),
    build_simple_formula_couple('isf_reduc_pac', FloatCol(function = isf._isf_reduc_pac,
        entity = 'foy')),
    build_simple_formula_couple('isf_inv_pme', FloatCol(function = isf._isf_inv_pme,
        entity = 'foy',
        start = date(2008, 1, 1))),
    build_simple_formula_couple('isf_org_int_gen', FloatCol(function = isf._isf_org_int_gen,
        entity = 'foy')),
    build_simple_formula_couple('revetproduits', FloatCol(function = isf._revetproduits,
        entity = 'foy')),
    build_dated_formula_couple('isf_apres_plaf',
        [
            dict(start = date(2002, 1, 1),
              end = date(2011, 12, 31),
        ...
        FloatCol(entity='foy')),
    build_simple_formula_couple('decote_isf', FloatCol(function = isf._decote_isf_2013_,
        entity = 'foy',
        start = date(2013, 1, 1))),
    build_simple_formula_couple('isf_tot', FloatCol(function = isf._isf_tot,
        entity = 'foy',
    ...
    #                            Bouclier Fiscal
    ############################################################
    build_simple_formula_couple('rvcm_plus_abat', FloatCol(function = isf._rvcm_plus_abat,
        entity = 'foy')),
    build_simple_formula_couple('maj_cga', FloatCol(function = isf._maj_cga,
        entity = 'foy')),
    ...
    build_simple_formula_couple('etu', BoolCol(function = pf._etu,
        label = u"Indicatrice individuelle étudiant",
        )),
    build_simple_formula_couple('biact', BoolCol(function = pf._biact,
        entity = 'fam',
        label = u"Indicatrice de biactivité",
        )),
    build_simple_formula_couple('concub', BoolCol(function = pf._concub,
        entity = 'fam',
        label = u"Indicatrice de vie en couple",
        )),
    build_simple_formula_couple('maries', BoolCol(function = pf._maries,
        entity = 'fam')),
    build_simple_formula_couple('nb_par', FloatCol(function = pf._nb_par,
        entity = 'fam',
        label = u"Nombre de parents",
        )),
    build_simple_formula_couple('smic55', BoolCol(function = pf._smic55,
        label = u"Indicatrice individuelle d'un salaire supérieur à 55% du smic",
        )),
    build_simple_formula_couple('isol', BoolCol(function = pf._isol,
        entity = 'fam')),
    ...
    build_simple_formula_couple('br_pf_i', FloatCol(function = pf._br_pf_i,
        label = 'Base ressource individuele des prestations familiales')),
    build_simple_formula_couple('br_pf', FloatCol(function = pf._br_pf,
        entity = 'fam',
    ...
    build_simple_formula_couple('paje_base_temp', FloatCol(function = pf._paje_base,
        entity = 'fam',
        label = u"Allocation de base de la PAJE sans tenir compte d'éventuels cumuls",
        start = date(2004, 1, 1))),
    build_simple_formula_couple('paje_base', FloatCol(function = pf._paje_cumul,
        entity = 'fam',
    ...
    build_simple_formula_couple('paje_nais', FloatCol(function = pf._paje_nais,
        entity = 'fam',
        label = u"Allocation de naissance de la PAJE",
        start = date(2004, 1, 1),
        url = u"http://vosdroits.service-public.fr/particuliers/F2550.xhtml",
        )),
    build_simple_formula_couple('paje_clca', FloatCol(function = pf._paje_clca,
        entity = 'fam',
        label = u"PAJE - Complément de libre choix d'activité",
        start = date(2004, 1, 1),
        url = u"http://vosdroits.service-public.fr/particuliers/F313.xhtml",
        )),
    build_simple_formula_couple('paje_clca_taux_plein', BoolCol(function = pf._paje_clca_taux_plein,
        entity = 'fam',
        label = u"Indicatrice Clca taux plein",
        start = date(2004, 1, 1),
        url = u"http://vosdroits.service-public.fr/particuliers/F313.xhtml",
        )),
    build_simple_formula_couple('paje_clca_taux_partiel', BoolCol(function = pf._paje_clca_taux_partiel,
        entity = 'fam',
        label = u"Indicatrice Clca taux partiel",
        start = date(2004, 1, 1),
        url = u"http://vosdroits.service-public.fr/particuliers/F313.xhtml",
        )),
    build_simple_formula_couple('paje_colca', FloatCol(function = pf._paje_colca,
        entity = 'fam',
    ...
    build_simple_formula_couple('paje_clmg', FloatCol(function = pf._paje_clmg,
        entity = 'fam',
    ...
    build_simple_formula_couple('paje', FloatCol(function = pf._paje,
        entity = 'fam',
    ...
    build_dated_formula_couple('aeeh',
        [
            dict(start = date(2002, 1, 1),
              end = date(2002, 12, 31),
    ...
    build_simple_formula_couple('crds_pfam', FloatCol(function = pf._crds_pfam,
        entity = 'fam',
    ...
    build_simple_formula_couple('br_al', FloatCol(function = lg._br_al,
        entity = 'fam',
        label = u"Base ressource des allocations logement",
        )),
    build_simple_formula_couple('al_pac', FloatCol(function = lg._al_pac,
        entity = 'fam',
        label = u"Nombre de personnes à charge au sens des allocations logement",
        )),
    build_simple_formula_couple('al', FloatCol(function = lg._al,
        entity = 'fam',
        label = u"Allocation logement (indifferrenciée)",
        )),
    build_simple_formula_couple('alf', FloatCol(function = lg._alf,
        entity = 'fam',
        label = u"Allocation logement familiale",
        url = u"http://vosdroits.service-public.fr/particuliers/F13132.xhtml",
        )),
    build_simple_formula_couple('als', FloatCol(function = lg._als,
        entity = 'fam',
        label = u"Allocation logement sociale",
        url = u"http://vosdroits.service-public.fr/particuliers/F1280.xhtml",
        )),
    build_simple_formula_couple('als_nonet', FloatCol(function = lg._als_nonet,
        entity = 'fam',
        label = u"Allocation logement sociale (non étudiant)",
        )),
    build_simple_formula_couple('alset', FloatCol(function = lg._alset,
        entity = 'fam',
    ...
    build_simple_formula_couple('apl', FloatCol(function = lg._apl,
        entity = 'fam',
        label = u"Aide personalisée au logement",
        url = u"http://vosdroits.service-public.fr/particuliers/F12006.xhtml",
        )),
    build_simple_formula_couple('crds_lgtm', FloatCol(function = lg._crds_lgtm,
        entity = 'fam',
        label = u"CRDS (allocation logement)",
        url = u"http://vosdroits.service-public.fr/particuliers/F17585.xhtml",
        )),
    build_simple_formula_couple('zone_apl', EnumCol(function = lg._zone_apl, default = 2,
        entity = 'men',
        enum = Enum([
            u"Non renseigné",
            u"Zone 1",
    ...
    build_simple_formula_couple('asi_coexist_aspa', FloatCol(function = ms._asi_coexist_aspa,
        entity = 'fam',
        label = u"Allocation supplémentaire d'invalidité quand un adulte de la famille perçoit l'ASPA",
        )),
    build_simple_formula_couple('asi_pure', FloatCol(function = ms._asi_pure,
        entity = 'fam',
        label = u"Allocation supplémentaire d'invalidité quand aucun adulte de la famille ne perçoit l'ASPA",
        )),
    ...
    build_simple_formula_couple('aspa_coexist_asi', FloatCol(function = ms._aspa_coexist_asi,
        entity = 'fam',
        label = u"Allocation de solidarité aux personnes agées quand un adulte de la famille perçoit l'ASI",
        )),
    build_dated_formula_couple('aspa_pure',
        [
            dict(start = date(2002, 1, 1),
              end = date(2006, 12, 31),
              function = ms._aspa_pure__2006,
             ),
            dict(start = date(2007, 1, 1),
              end = date(2015, 12, 31), #TODO: actualiser la date (si la loi n'a pas changé)
              function = ms._aspa_pure_2007_,
             ),
        ],
        FloatCol(entity='fam',
        label = u"Allocation de solidarité aux personnes agées quand aucun adulte de la famille ne perçoit l'ASI")),
#    build_simple_formula_couple('aspa_pure', FloatCol(function = ms._aspa_pure,
#        entity = 'fam',
#        label = u"Allocation de solidarité aux personnes agées quand aucun adulte de la famille ne perçoit l'ASI",
#        )),
    ...
    build_simple_formula_couple('tax_hab', FloatCol(function = th._tax_hab,
        entity = 'men',
    ...
    ############################################################
    build_simple_formula_couple('uc', FloatCol(function = cm._uc,
        entity = 'men',
    ...
    build_simple_formula_couple('revdisp', FloatCol(function = cm._revdisp,
        entity = 'men',
        label = u"Revenu disponible du ménage",
        url = u"http://fr.wikipedia.org/wiki/Revenu_disponible",
        )),
    build_simple_formula_couple('nivvie', FloatCol(function = cm._nivvie,
        entity = 'men',
        label = u"Niveau de vie du ménage",
        )),

    build_simple_formula_couple('revnet', FloatCol(function = cm._revnet,
        entity = 'men',
        label = u"Revenu net du ménage",
        url = u"http://impotsurlerevenu.org/definitions/115-revenu-net-imposable.php",
        )),
    build_simple_formula_couple('nivvie_net', FloatCol(function = cm._nivvie_net,
        entity = 'men',
        label = u"Niveau de vie net du ménage",
        )),

    build_simple_formula_couple('revini', FloatCol(function = cm._revini,
        entity = 'men',
        label = u"Revenu initial du ménage",
        )),
    build_simple_formula_couple('nivvie_ini', FloatCol(function = cm._nivvie_ini,
        entity = 'men',
    ...
    build_simple_formula_couple('cotsoc_bar', FloatCol(function = cm._cotsoc_bar,
        label = u"Cotisations sociales sur les revenus du capital imposés au barème",
        )),
    build_simple_formula_couple('cotsoc_lib', FloatCol(function = cm._cotsoc_lib,
    ...
    build_simple_formula_couple('psoc', FloatCol(function = cm._psoc,
        entity = 'fam',
        label = u"Total des prestations sociales",
        url = u"http://fr.wikipedia.org/wiki/Prestation_sociale",
        )),
    build_simple_formula_couple('prelsoc_cap', FloatCol(function = cm._prelsoc_cap,
    ...
    build_simple_formula_couple('pfam', FloatCol(function = cm._pfam,
        entity = 'fam',
    ...
    build_simple_formula_couple('mini', FloatCol(function = cm._mini,
        entity = 'fam',
        label = u"Minima sociaux",
        url = u"http://fr.wikipedia.org/wiki/Minima_sociaux",
        )),
    build_simple_formula_couple('logt', FloatCol(function = cm._logt,
        entity = 'fam',
    ...
    build_simple_formula_couple('crds', FloatCol(function = cm._crds,
        label = u"Total des contributions au remboursement de la dette sociale",
        )),
    build_simple_formula_couple('csg', FloatCol(function = cm._csg,
        label = u"Total des contributions sociale généralisée",
        )),
    build_simple_formula_couple('cotsoc_noncontrib', FloatCol(function = cm._cotsoc_noncontrib,
        label = u"Cotisations sociales non contributives",
        )),
    build_simple_formula_couple('check_csk', FloatCol(function = cm._check_csk,
        entity = 'men')),
    build_simple_formula_couple('check_csg', FloatCol(function = cm._check_csg,
        entity = 'men')),
