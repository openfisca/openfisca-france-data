...
# 0 Propri�taire non-acc�dant
# 1 Acc�dant � la propri�t�
# 2 Locataire d'un logement lou� vide
# 3 Autre locataire (log� en meubl�, h�tel ou garni), sous-locataire
# 4 Fermier ou m�tayer
# 5 Log� gratuitement
...
"La variable ACTEU5 est une recomposition de l'activit� au sens BIT52 de la personne en 5 modalit�s :
  '1' = � salari� �,
'2' = � ind�pendant �,
'3' = � ch�meur �,
'4' = � retrait� �,
'5' = � autre inactif �,
calcul�e � partir des variables de l' EEC : ACTEU6 et STATUT et de l'ERFS-EEC : CS8COR.
La variable ACTEU5 est dans la table INDIVI06. Les variables ACTEU5PR et ACTEU5CJ (pour la personne de r�f�rence et le conjoint) sont dans la table MENAGE06."

# MSITUA Table : MENAGE
# OCCUPATION PRINCIPALE DE LA PERSONNE DE REFERENCE
# 1 Occupe actuellement un emploi
# 2 Apprenti sous contrat ou en stage r�mun�r� --> 1 
# 3 Etudiante, �l�ve, en formation ou en stage r�mun�r� --> 5
# 4 Ch�meur (inscrit ou non � l'ANPE) --> 3 
# 5 Retrait� ou retir� des affaires ou en pr�retraite --> 4
# 6 Femme ou homme au foyer--> 5 
# 7 Autre situation (personne handicap�e, ...) --> 5
...
# 200 M�nage de plusieurs personnes sans famille --> 5
...
# enq ERF
# DDIPL
# Dipl�me le plus �lev� obtenu (7 postes)
# Dipl�me non d�clar�
# 1 Dipl�me sup�rieur
...
# 1 Aucun dipl�me --> 7
# 2 Certificat d'�tudes primaires (CEP) --> 7
# 3 Brevet d'�tudes du 1er cycle (BEPC) ou BE, ou brevet des coll�ges --> 6
# 4 CAP, BEP ou autre dipl�me de ce niveau --> 5
# 5 Baccalaur�at professionnel --> 4 
# 6 Baccalaur�at technique ou technologique --> 4
# 7 Baccalaur�at g�n�ral --> 4
# 8 Bac+2 --> 3
# 9 Sup�rieur � BAC+2 --> 1
...
# REVENU ANNUEL TOTAL PER�U PAR LE MENAGE EN FRANCE METRO
# - en d�ciles - redress� - corrig�e
# 1 Moins de 9 754 
# 2 De 9 754  � moins de 13 335 
# 3 De 13 335  � moins de 16 900 
# 4 De 16 900  � moins de 20 540 
# 5 De 20 540  � moins de 25 037 
# 6 De 25 037  � moins de 29 969 
# 7 De 29 969  � moins de 35 262 
# 8 De 35 262  � moins de 42 560 
# 9 De 42 560  � moins de 55 000 
# 10 55 000  et plus
...
# 3 De 20 000 � 100 000 habitants
# 4 Plus de 100 000 habitants
# 5 Agglom�ration parisienne hors Paris et Ville de Paris 

# Tranche d'unit� urbaine en 9 postes
# 0 Commune rurale --> 1 
# 1 Unit� urbaine de moins de 5 000 habitants --> 2
# 2 Unit� urbaine de 5 000 � 9 999 habitants --> 2
# 3 Unit� urbaine de 10 000 � 19 999 habitants --> 2
# 4 Unit� urbaine de 20 000 � 49 999 habitants --> 3
# 5 Unit� urbaine de 50 000 � 99 999 habitants --> 3
# 6 Unit� urbaine de 100 000 � 199 999 habitants --> 4
# 7 Unit� urbaine de 200 000 � 1 999 999 habitants --> 4
# 8 Unit� urbaine de Paris --> 5
...
## imputation de la valeur de r�sidence principale
...
## Pour ne pas fausser, on effectue les m�mes �tapes sur la base pat- pat_pr�dit+ res
allvars <- c("occuppr", "agepr","occupcj","diplopr","logrminterdeb", "sexepr", "typmen")
classes <- c("typmen", "diplopr") 
#matching variables
matchvars <- setdiff(allvars, classes)
