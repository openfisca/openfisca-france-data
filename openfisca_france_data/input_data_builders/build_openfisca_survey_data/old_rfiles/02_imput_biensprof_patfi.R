...
table(pat$fit)
## REVOIR- le mod�le n'est pas suffisamment robuste
## 0.25 est totalement arbitraire mais permet de retrouver la proportion de menage d�tenteur de biens prof tel que def par profna3
## dans base ERF pr�dire 
